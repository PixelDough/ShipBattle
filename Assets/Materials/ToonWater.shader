	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = ( (( round( saturate( temp_output_46_0 ) ) == 1.0 ) ? _DepthGradientShallow :  _DepthGradientDeep ) + float4( 0,0,0,0 ) + (( round( saturate( ( ( temp_output_46_0 - distanceDepth74 ) * 10.0 ) ) ) == 1.0 ) ? _DepthGradientShallow :  float4( 0,0,0,0 ) ) ).rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=17500
0;664;1475;335;939.6478;228.7209;1.873927;True;False
...
Node;AmplifyShaderEditor.TFHCCompareEqual;113;473.5798,-243.7202;Inherit;False;4;0;FLOAT;0;False;1;FLOAT;1;False;2;COLOR;0,0,0,0;False;3;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.FresnelNode;103;-713.8229,-61.39917;Inherit;False;Standard;WorldNormal;ViewDir;False;5;0;FLOAT3;0,0,1;False;4;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;5;False;1;FLOAT;0
...
WireConnection;109;2;49;0
ASEEND*/
//CHKSM=CED4D906C06CD535CD67946650B5162DBB1D0559