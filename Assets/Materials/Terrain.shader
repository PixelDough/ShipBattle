...
Shader "ShipBattle/TerrainFirstPass"
{
	Properties
	{
		_SandColor("Sand Color", Color) = (0.8207547,0.7096044,0.4839356,1)
		_TopColor("Top Color", Color) = (0.3775365,0.7924528,0.4121128,1)
	...
	SubShader
	{
		...
		Tags { "RenderPipeline"="UniversalPipeline" "RenderType"="Opaque" "Queue"="Geometry-100" "SplatCount"="4" }
